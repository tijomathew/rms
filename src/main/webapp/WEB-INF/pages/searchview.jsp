            ...
            <div class="col-xs-12 col-sm-12">
                <br class="panel panel-default">
                    ...
                    <label>Phone -2: </label> <c:if
                        test="${not empty searchParent.alternativePhoneNumber}"> ${searchParent.alternativePhoneNumber}</c:if></br>
                ...
                <div class="col-md-12">
                    <c:forEach items="${searchParent.studentNodeList}" var="element"
                        ...
                        <div class="col-md-3">
                            <label>Section:</label><c:if
                                test="${not empty element.retreatSection}">${element.retreatSection}</c:if></br>
                        </div>
                        <div class="col-md-2">
                            <label>Band Code:</label><c:if
                                test="${not empty element.bandCode}">${element.bandCode}</c:if></br>
                        </div>
                        <div class="col-md-4">
                            <label>Days:</label>
                            <c:if
